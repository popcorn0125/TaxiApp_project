import { SafeAreaView, StyleSheet, Text, View, FlatList, Modal, Alert, TouchableOpacity } from "react-native";
...
function Main_List() : JSX.Element {
    ...
    const filterCalls = () => {
        if(filter === "") {
            ...
            setFilteredCalls(callList.filter((call:any) => call.call_state === filter));
        }
    }
