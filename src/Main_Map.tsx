...
import MapView, {PROVIDER_GOOGLE, Marker, Polyline, Animated} from "react-native-maps";
...
function Main_Map() : JSX.Element {
    ...
    const callTaxi = async () => {
        ...
        let endAddr = autoComplete1.current.getAddressText()
    ...
    let query = {
        key : "AIzaSyCb5bUzPkafctbLPhuLkJ3XpQGEkpl7TYY",
        language : 'ko',
    ...
    return ( 
        <SafeAreaView style={styles.container}>
            ...
            <View style={{position:'absolute', width:'100%', height:'100%', padding:10}}>
                ...
                <TouchableOpacity style={[styles.button, {position:'absolute',width:wp(18), top:wp(2), right:wp(2), height:90, justifyContent:'center'}]}
                                    onPress={callTaxi}>
...
const autocompletStyle = StyleSheet.create({
    textInputContainer : {
        width: '100%',
